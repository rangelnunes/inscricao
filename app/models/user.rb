class User < ActiveRecord::Base
  ...
  validates_presence_of :password, :presence => true, :on => :create, :message => 'deve ser informada'
  validates_presence_of :password_confirmation, :presence => true, :on => :create, :message => 'deve ser informada'
	validates_presence_of :tipo, :presence => true, :on => :create, :message => 'deve ser informado'     
